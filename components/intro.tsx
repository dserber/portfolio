  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">web & mobile developer</span> with{" "}
      ...
      <motion.div
        className="group flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <a
          ...
          href="https://linkedin.com/in/davidwserber/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
